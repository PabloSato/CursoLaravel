<nav class="bg-gray-800" x-data="{ open: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            {{-- ESTA DIRCTIVA COMPRUEBA SI EL USUARIO SE ENCUENTRA AUTENTIFICADO Y EN ESE CASO, MUESTRA LO QUE HAY AQUI DENTRO --}}
            @auth
                {{-- LADO DERECHO DEL MENU (USUARIO) --}}
                <div class="hidden md:block">
                ...
                {{--  EN CASO DE QUE NO ESTÉ AUTENTIFICADO, MOSTRAMOS LO QUE ESTÁ EN EL ELSE --}}
            @else
                <div>
                    <a href="{{ route('login') }}"
    ...
    <div class="md:hidden" id="mobile-menu" x-show="open" x-on:click.await="open = false">
